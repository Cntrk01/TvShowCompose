...
//val throwable = (loadState.refresh as LoadState.Error).error tip olarak zaten NetworkError geliyor.Ondan dolayı tekrar CustomExceptions içerisinde throw vermeye gerek yok.
